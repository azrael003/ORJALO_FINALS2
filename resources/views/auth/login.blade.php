...
>
  ...
  >
    ...
    <form method="POST" action="{{ route('login') }}" class="space-y-5">
      ...
      <div x-data="{ show: false }" class="relative">
        ...
        <input
          ...
          name="password"
          required
          class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-400 dark:focus:ring-pink-600 dark:bg-gray-700 dark:text-white pr-10"
        />
        <button
          type="button"
          @click="show = !show"
    ...
    <!-- Footer Links -->
    <div class="text-center text-sm text-gray-600 dark:text-gray-400 mt-6 space-y-2">
